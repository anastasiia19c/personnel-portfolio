...
const projectDetails = [
  ...
  },
  {
    ...
    qui permet de gérer différentes formes géométriques. L’application et l’API sont codées en suivant les principes de la  
    Programmation Orientée Objets (POO). Cette application permettra de créer et supprimer des formes géométriques suivant 
    différentes caractéristiques, de créer, enregistrer et partager des compositions, voire de contribuer sur une composition 
    existante ou en cours de création. Cette application devra aussi afficher quelques caractéristiques mathématiques de la composition 
  ...
  },
  {
    ...
    Développement d’une application web pour la gestion des candidats à l’admission en formation, 
  ...
  },
  {
    ...
    permettant une gestion efficace des opportunités commerciales et un suivi des interactions avec les clients potentiels. 
  ...
  },
  {
    ...
    Les questions et les réponses fournies par le client sont enregistrées dans une base de données. 
    La création d’un fichier PDF contenant des graphiques basés sur les réponses. 
